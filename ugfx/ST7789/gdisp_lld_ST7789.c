...
#warning                                                                       \
    "GDISP: This low level driver does not support setting a screen size. It is being ignored."
#elif GFX_COMPILER_WARNING_TYPE == GFX_COMPILER_WARNING_MACRO
COMPILER_WARNING("GDISP: This low level driver does not support setting a "
                 "screen size. It is being ignored.")
#endif
...
#define write_data_repeat(g, data, count)                                      \
    {                                                                          \
        int i;                                                                 \
        for (i = 0; i < count; ++i)                                            \
            write_data(g, data);                                               \
...
LLDSPEC gI8 gdisp_lld_init(GDisplay *g) {
